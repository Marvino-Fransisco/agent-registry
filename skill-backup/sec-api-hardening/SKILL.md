---
name: sec-api-hardening
description: Design and audit API security controls including rate limiting, CORS, request validation, method enforcement, versioning, and abuse prevention. Use when reviewing REST or GraphQL APIs for security, designing rate limiting strategies, auditing public-facing endpoints, or hardening API gateways. Trigger for any mention of rate limiting, API abuse, DDoS protection, endpoint hardening, API security, throttling, or API gateway configuration.
---
