---
name: se-code-flow-diagram
description: Create clear code flow diagrams showing execution paths, data transformations, and control flow for a feature or module. Use this skill whenever the software engineer agent needs to visualise how code executes, explain a complex flow, or plan the structure of a new feature. Trigger on any "flow", "diagram", "sequence", "how does this work", or "walk me through" request.
---
