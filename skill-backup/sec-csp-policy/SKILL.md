---
name: sec-csp-policy
description: Design, audit, and implement Content Security Policy (CSP) headers and the full suite of browser security headers. Use when reviewing or configuring HTTP security headers, CSP directives, iframe protection, clickjacking prevention, MIME sniffing, or referrer policies. Trigger for any mention of CSP, Content-Security-Policy, clickjacking, X-Frame-Options, security headers, HSTS, or browser security hardening. Covers CSP, HSTS, X-Frame-Options, X-Content-Type-Options, Referrer-Policy, Permissions-Policy, and CORS.
---
