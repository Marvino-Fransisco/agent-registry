---
name: se-refactor-plan
description: Plan and execute safe, incremental refactoring of existing code without breaking functionality. Use this skill whenever the software engineer agent needs to clean up, restructure, or improve existing code. Trigger on any "refactor", "clean up", "restructure", "improve this code", or technical debt reduction request.
---
