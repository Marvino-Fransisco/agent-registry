---
name: sec-owasp-checklist
description: Apply the OWASP Top 10 (2021) as a structured audit checklist against any feature or codebase. Use when performing a pre-launch security review, a general security audit, or when mapping identified vulnerabilities to OWASP categories. Trigger for any mention of OWASP, security audit, security review, pre-launch checklist, or compliance check. Provides a complete walkthrough of all 10 categories with pass/fail criteria and remediation pointers.
---
