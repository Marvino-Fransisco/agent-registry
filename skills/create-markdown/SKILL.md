...
description: >
  ...
  Trigger it when creating, editing, formatting, or validating .md content.
  It ensures correct Markdown syntax, consistent structure, and clean readability.
  Apply it for tasks such as generating documents, adding headings, lists, code blocks, links, placeholders, and enforcing formatting conventions.
---

# Create Markdown Skill

This skill contains the rules when creating markdown that you must follow
