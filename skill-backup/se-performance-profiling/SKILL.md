---
name: se-performance-profiling
description: Identify and fix performance bottlenecks in code including algorithmic complexity issues, unnecessary computations, memory leaks, and inefficient data structures. Use this skill whenever the software engineer agent is optimising code, investigating slowness, or reviewing code for performance impact. Trigger on any "slow", "performance", "optimise", "bottleneck", "memory leak", "complexity", or "Big O" concern.
---
