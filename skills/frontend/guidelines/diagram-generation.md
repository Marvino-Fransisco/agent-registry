...
produce clear, accurate diagrams in Mermaid syntax that illustrate the feature's architecture, data flow, and state transitions.
...
1. **Data Flow** — when state management is complex
2. **Sequence Diagram** — when API interaction sequence matters
