---
name: sec-markdown-format
description: Format and structure security design documents consistently. Use when writing, finalizing, or reviewing any security design markdown file before saving to the designs folder or uploading to Notion. Trigger whenever a security design doc is being created or edited, or when the agent needs to assemble findings from multiple skills into a coherent [feature-name]-security-design.md file.
---
