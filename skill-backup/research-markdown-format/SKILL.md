...
description: >
  Use this skill to format and structure all research output markdown files consistently.
  Trigger at the end of every research task when writing the final report to the `researches/`
  folder. This skill defines the canonical structure, heading hierarchy, table format, badge
  conventions, and writing style for all researcher agent outputs. Always use this skill
  before saving any `[topic]-research.md` file to ensure reports are consistent, scannable,
  and decision-ready.
---
